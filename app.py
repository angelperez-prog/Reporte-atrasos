        ...
        try:
            ...
            if total_encontrados == 0:
                ...
                if records:
                    ...
                    # --- MÉTRICAS Y GRÁFICOS (AL FINAL DE LA PÁGINA) ---
                    st.subheader("📊 Análisis Gráfico de Atrasos")

                    # 1. Gráfico: Días que más faltas
                    ...
                    fig_dias = px.bar(
                        ...
                        title="Frecuencia de Atrasos por Día de la Semana"
                    )
